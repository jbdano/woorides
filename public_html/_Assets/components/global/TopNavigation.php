    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li class=""><a href="#services" id="navItem-services" class="smoothScroll">Services <span
                            class="sr-only">(current)</span></a></li>
                <li><a href="About-Us" id="navItem-about" class="smoothScroll">About Us</a></li>
                <li><a href="#press" id="navItem-press" class="smoothScroll">Press</a></li>
                ...
                <li><a href="https://squareup.com/appointments/book/daeb64a0-95f2-4a1e-8a6f-4f08b92d2a8c/12QARAKR1YM1A/services"
                        target="_blank" id="navItem-cta" class="navbar_contact_btn">Book Tour</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>